...
#define RISING_EDGE                                          1
	...
	#define TIMER_DIVISION_FACTOR_32                           3
	#define TIMER_DIVISION_FACTOR_64	                         4
	#define TIMER_DIVISION_FACTOR_128                         5
	#define TIMER_DIVISION_FACTOR_256	                     6
	#define TIMER_DIVISION_FACTOR_1024	                     7
